...
with open(r"C:\Python_Projects\ЕГЭ_Информатика\22. Многопроцессорные системы\Поляков\6524\file.csv", "r",
    ...
    dict1 = dict()
    dict2 = dict()
    matrix = [[0] * 200 for i in range(len(reader))]
    for row in reader:
        id_B = int(row[0])
